...
console.log("5 - Editar Funcionário");
console.log("6 - Excluir Funcionário");
console.log("0 - SAIR");
console.log("===============");
// O que vêm depois?
...
rl.question("Digite o opção desejada: ", (input) => {
    ...
    switch (opcao) {
        ...
        case 5:
            limparTexto();
            console.log("Opção 5: Editar Funcionário");
            editar();
            break;
        case 6: 
            limparTexto();
            console.log("Opção 6: Excluir Funcionário");
            deletar();
            break;
        case 0:
            limparTexto();
        ...
        rl.question("Digite o novo nome do funcionário: ", (i1) => {
            ...
            rl.question("Digite o novo cargo do funcionário: ", (i2) => {
                ...
                rl.question("Digite o novo salário do funcionário: ", (i3) => {
                    ...
                    cadastro[i].nome = i1;
                    cadastro[i].cargo = i2;
                    cadastro[i].salario = parseFloat(i3);
